...
final public class RXTXPort extends SerialPort
{
  ...
  public void setFlowControlMode (int flowcontrol)
  {
	...
	if (debug_events)
	  z.reportln
	    ("RXTXPort:setFlowControlMode MonThread is Interrupeted returning");
	return;
      }
    try
    {
  ...
  public void disableReceiveFraming ()
  {
    if (debug)
      z.reportln
	("RXTXPort:disableReceiveFramming() called and returning (noop)");
  }
	/** 
  ...
  {
    if (debug)
      z.reportln ("RXTXPort:isReceiveFrammingEnabled() called and returning "
		  + false);
    return false;
  }
	/** 
  ...
  {
    if (debug)
      z.reportln ("RXTXPort:getReceiveFrammingByte() called and returning " +
		  0);
    return 0;
  }
  ...
  public void addEventListener (SerialPortEventListener lsnr) throws
  ...
  class SerialOutputStream extends OutputStream
  {
	...
	*/
      ...
      if (monThreadisInterrupted == true)
	{
	  if (debug)
	    z.reportln
	      ("RXTXPort:SerialOutputStream:flush() Leaving Interrupted");
	  return;
	}
      IOLocked++;
      waitForTheNativeCodeSilly ();
...
*0       >0      blocks until reads threshold bytes
	*/
      ...
      if (monThreadisInterrupted == true)
	{
      ...
      if (debug_read_results)
	z.reportln ("RXTXPort:SerialInputStream:read() returned " + result +
		    " bytes");
      IOLocked--;
      return (result);
    }
...
/*------------------------  END OF CommAPI -----------------------------*/
  ...
  {
    if (debug)
      z.reportln ("RXTXPort:staticSetSerialPortParams( " +
		  f + " " + b + " " + d + " " + s + " " + p);
